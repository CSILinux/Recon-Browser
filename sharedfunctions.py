...
logo_path = pathMe("assets/fingerprint.png")
...
class BrowseMe(QMainWindow):
    ...
    def navigate_to_url(self):
        ...
        if q.scheme() == "":
            q.setScheme("http")
        if urlparse(self.urlbar.text()).netloc.endswith('.onion') and WhatIsMyTorIP()[1] == None:
...
def csitoolsinit(case, csitoolname):
    ...
    icon = pathMe("assets/csi_black.png", True)
